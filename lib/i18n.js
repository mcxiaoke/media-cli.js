...
const translations = {
    ...
    "ffmpeg.processing": {
        zh: "处理文件: {{path}}",
        en: "Processing file: {{path}}",
    },
    "ffmpeg.skipped": {
        zh: "{{index}} 跳过 {{path}} ({{size}}) [TestMode]",
        en: "{{index}} Skipped {{path}} ({{size}}) [TestMode]",
    },
    "ffmpeg.retrying": {
        zh: "重试任务: {{path}}",
        en: "Retrying task: {{path}}",
    },
    ...
    "remove.sizel": { zh: "大小不小于此值的文件将被删除（单位:K，1024 进制，含边界）", en: "Files size >= value will be removed (unit:K, 1024-based, inclusive)" },
    "remove.sizer": { zh: "大小不大于此值的文件将被删除（单位:K，1024 进制，含边界）", en: "Files size <= value will be removed (unit:K, 1024-based, inclusive)" },
    "remove.pattern": {
        zh: "文件名模式匹配此值的文件将被删除",
    ...
    "prefix.mode": { zh: "文件名前缀模式 (auto/dir/prefix/media/seq/clean)", en: "filename prefix mode (auto/dir/prefix/media/seq/clean)" },
    ...
    "prefix.suffix.date": { zh: "日期时间后缀", en: "date time suffix" },
    "prefix.suffix.seq": { zh: "序号后缀", en: "sequence suffix" },
    "prefix.suffix.size": { zh: "文件大小后缀", en: "file size suffix" },
    "prefix.seq.start": { zh: "序号的起始值", en: "sequence start value" },
    "prefix.seq.pad": { zh: "序号补零位数", en: "sequence padding digits" },

    // ========== run 命令 ==========
    "run.description": { zh: "运行独立任务（占位命令，尚未实现）", en: "Run standalone tasks (placeholder, not implemented yet)" },
    "run.not_implemented": {
    ...
    "option.pick.hashAlgo": {
        zh: "哈希算法: md5/sha/average/perceptual/block/wavelet",
        en: "Hash algorithm: md5/sha/average/perceptual/block/wavelet",
    },
