...
const NON_CJKERA_CHARS = /[^\p{sc=Hani}\p{sc=Hira}\p{sc=Kana}\p{sc=Hang}\p{sc=Cyrl}A-Za-z0-9 ]/u;
const REGEX_HAS_NON_WORD_CHARS = NON_CJKERA_CHARS;
...
export {
  NON_CJKERA_CHARS, strHasASCII, strHasHangul, strHasHani, strHasHiraKana, strHasNonWordChars, strOnlyASCII, strOnlyHangul, strOnlyHani, strOnlyNonWordChars
};
