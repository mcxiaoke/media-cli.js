...
export const REGEX_JAPANESE_ONLY = new RegExp(`^[\\p{ASCII}\\u2012-\\u2051\\u2150-\\u218f\\u2600-\\u27bf\\u3000-\\u303f\\u3040-\\u309f\\u30a0-\\u30ff\\uff01-\\uff20${JAPANESE_HAN}${COMMON_JP_CHARS}]+$`, 'u');
/**
 * 判断给定字符串中是否包含日文字符
 * @param {string} str 需要进行判断的字符串
...
export const REGEX_CHINESE_ONLY = new RegExp(`^[\\p{ASCII}\\u00a1-\\u00b7\\u2012-\\u2051\\u2150-\\u218f\\u2600-\\u27bf\\u3000-\\u303f\\u3040-\\u309f\\u30a0-\\u30ff\\uff01-\\uff20${CHINESE_CHARS_3500}]+$`, 'u');
