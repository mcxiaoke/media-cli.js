 ...
 * Modified: 2024-04-23 20:25:56
 * Author: mcxiaoke (github@mcxiaoke.com)
 * License: Apache License 2.0
 */
import { CHINESE_CHARS_3500, CHINESE_CHARS_7000, JAPANESE_HAN } from './unicode_data';
...
/**
 * 定义一个正则表达式用于匹配仅包含日文汉字的字符串。
 * 
 * @constant {RegExp} REGEX_JAPANESE_HAN - 用于匹配日文汉字的正则表达式对象。
 * @global
 */
export const REGEX_JAPANESE_HAN = new RegExp(`/^[${JAPANESE_HAN}]+$/`, "ugi");

/**
 * 检查给定字符串是否只包含日文汉字。
 * 
 * @param {string} str - 需要检查的字符串。
 * @returns {boolean} 如果字符串只包含日文汉字则返回true，否则返回false。
 */
export const strOnlyJapaneseHan = REGEX_JAPANESE_HAN.test(str);
 ...
 * @type {RegExp}
 */
export const REGEX_CHINESE_HAN_7000 = new RegExp(`/^[${CHINESE_CHARS_7000}]+$/`, "ugi");
 ...
 */
export const strOnlyChineseHan7000 = REGEX_CHINESE_HAN_7000.test(str)

/**
 * 定义一个正则表达式，用于匹配仅包含3500个常用中文字符的字符串。
 * @type {RegExp}
 */
export const REGEX_CHINESE_HAN_3500 = new RegExp(`/^[${CHINESE_CHARS_3500}]+$/`, "ugi");
 ...
 */
export const strOnlyChineseHan3500 = REGEX_CHINESE_HAN_3500.test(str);
