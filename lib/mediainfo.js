...
export async function getMediaInfo(filePath, options = { useMediaInfo: true }) {
    ...
    if (err1) {
        // console.log('getMediaInfo err', err1)
        ...
        // console.log('getMediaInfo data', data1)
        if (data1.video) {
            // ugly fix for vp9 profile type is number
