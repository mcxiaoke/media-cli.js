...
// H264 AVC
const VCODEC_H264 = '-c:v h264_nvenc -rc vbr_hq -rc-lookahead 30'
//  HEVC -profile:v main -tune:v hq
const VCODEC_HEVC = '-c:v hevc_nvenc -rc vbr_hq -rc-lookahead 30'
...
// AVC H264基础参数
const H264_BASE = new FFmpegPreset('hevc-base', {
    format: '.mp4',
    type: 'video',
    smartBitrate: true,
    ...
    videoArgs: VCODEC_H264 + ' -cq {videoQuality} -bufsize {videoBitrate}k -maxrate {videoBitrate}k',
    // 音频参数说明
