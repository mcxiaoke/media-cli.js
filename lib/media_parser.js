...
class MediaStream {
    ...
    static fromFFprobe(data) {
        ...
        const stream = new MediaStream(obj)
...
export function fromFFprobeJson(data) {
    ...
    const obj = {
        ...
        audio: ad && MediaStream.fromFFprobe(ad),
        video: vd && MediaStream.fromFFprobe(vd),
    }
    const info = new MediaInfoData(convertNumber(obj))
...
export function fromMediaInfoJson(data) {
    ...
    const obj = {
        ...
        audio: ad && MediaStream.fromMediaInfo(ad),
        video: vd && MediaStream.fromMediaInfo(vd),
    }
    const info = new MediaInfoData(convertNumber(obj))
    removeFieldsBy(info, (k, v) => v === undefined || v === null)
    return info
