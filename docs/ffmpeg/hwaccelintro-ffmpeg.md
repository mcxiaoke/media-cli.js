---
created: 2026-09-20T10:25:08 (UTC +08:00)
source: https://trac.ffmpeg.org/wiki/HWAccelIntro
---

# HWAccelIntro – FFmpeg

[View WikiStart](https://trac.ffmpeg.org/wiki)[View HWAccelIntro](https://trac.ffmpeg.org/wiki/HWAccelIntro)
...
- [History](https://trac.ffmpeg.org/wiki/HWAccelIntro?action=history)

1. [Platform API Availability](https://trac.ffmpeg.org/wiki/HWAccelIntro#PlatformAPIAvailability)
2. [FFmpeg API Implementation Status](https://trac.ffmpeg.org/wiki/HWAccelIntro#FFmpegAPIImplementationStatus)
3. [ffmpeg](https://trac.ffmpeg.org/wiki/HWAccelIntro#Usewiththeffmpegcommand-linetool)
4. [VDPAU](https://trac.ffmpeg.org/wiki/HWAccelIntro#VDPAU)
5. [VAAPI](https://trac.ffmpeg.org/wiki/HWAccelIntro#VAAPI)
6. [DXVA2](https://trac.ffmpeg.org/wiki/HWAccelIntro#DXVA2)
7. [VideoToolbox](https://trac.ffmpeg.org/wiki/HWAccelIntro#VideoToolbox)
8. [Vulkan](https://trac.ffmpeg.org/wiki/HWAccelIntro#Vulkan)
9. [CUDA (NVENC/NVDEC)](https://trac.ffmpeg.org/wiki/HWAccelIntro#CUDANVENCNVDEC)
  1. [NVENC](https://trac.ffmpeg.org/wiki/HWAccelIntro#NVENC)
  2. [NVDEC/CUVID](https://trac.ffmpeg.org/wiki/HWAccelIntro#NVDECCUVID)
  3. [cuda-nvcc and libnpp](https://trac.ffmpeg.org/wiki/HWAccelIntro#cuda-nvccandlibnpp)
10. [libmfx (Intel Media SDK)](https://trac.ffmpeg.org/wiki/HWAccelIntro#libmfxIntelMediaSDK)
11. [OpenCL](https://trac.ffmpeg.org/wiki/HWAccelIntro#OpenCL)
12. [AMD UVD/VCE](https://trac.ffmpeg.org/wiki/HWAccelIntro#AMDUVDVCE)
  1. [Decoding](https://trac.ffmpeg.org/wiki/HWAccelIntro#Decoding)
  2. [Encoding](https://trac.ffmpeg.org/wiki/HWAccelIntro#Encoding)
  3. [Transcode](https://trac.ffmpeg.org/wiki/HWAccelIntro#Transcode)
  4. [Transcode with Scaling](https://trac.ffmpeg.org/wiki/HWAccelIntro#TranscodewithScaling)
13. [External resources](https://trac.ffmpeg.org/wiki/HWAccelIntro#Externalresources)
...
|  | **Linux** | **Linux** | **Linux** | **Windows** | **Windows** | **Windows** | **Android** | **Apple** | **Apple** | **Other** |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
|  | Decoder | Decoder | Decoder | Encoder | Encoder | Other support | Other support | Other support |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
[​](https://http.download.nvidia.com/XFree86/vdpau/doxygen/html/index.html). Developed by NVIDIA for Unix/Linux systems. To enable this you typically need the `libvdpau` development package in your distribution, and a compatible graphics card.
...
It can be used to access the Quick Sync hardware in Intel GPUs and the UVD/VCE hardware in AMD GPUs. See [VAAPI](https://trac.ffmpeg.org/wiki/Hardware/VAAPI).

# DXVA2

[​](https://msdn.microsoft.com/en-us/library/windows/desktop/cc307941(v=vs.85).aspx), developed by Microsoft (supports Windows and XBox360).

Several decoders are currently supported, in particular H.264, MPEG-2, VC-1 and WMV 3, AV1, HEVC.

DXVA2 hardware acceleration only works on Windows. In order to build FFmpeg with DXVA2 support, you need to install the dxva2api.h header. For MinGW this can be done by [​](https://download.videolan.org/pub/contrib/dxva2api.h) and installing it in the include path (for example in `/usr/include/`).
...
[​](https://developer.apple.com/documentation/videotoolbox) is the macOS framework for video decoding and encoding.
...
The AV1 specification is currently an experimental specification developed in collaboration with the [​](https://mesa3d.org/) project. As such, it should not be expected to be implemented on any other drivers currently, but once an official specification is available, the decoder will be ported to use it.
...
Documentation on how to initialize the device, as well as filtering, is available on our [documentation page](https://ffmpeg.org/ffmpeg-filters.html#Vulkan-Video-Filters).
...
- [cuda](https://trac.ffmpeg.org/tags/cuda)
- [direct3d](https://trac.ffmpeg.org/tags/direct3d)
- [dxva2](https://trac.ffmpeg.org/tags/dxva2)
- [hwaccel](https://trac.ffmpeg.org/tags/hwaccel)
- [mediacodec](https://trac.ffmpeg.org/tags/mediacodec)
- [mmal](https://trac.ffmpeg.org/tags/mmal)
- [nvenc](https://trac.ffmpeg.org/tags/nvenc)
- [opencl](https://trac.ffmpeg.org/tags/opencl)
- [quick](https://trac.ffmpeg.org/tags/quick)
- [sync](https://trac.ffmpeg.org/tags/sync)
- [va-api](https://trac.ffmpeg.org/tags/va-api)
- [vce](https://trac.ffmpeg.org/tags/vce)
- [vdpau](https://trac.ffmpeg.org/tags/vdpau)
- [videotoolbox](https://trac.ffmpeg.org/tags/videotoolbox)
- [vulkan](https://trac.ffmpeg.org/tags/vulkan)
...
NVDEC offers decoders for H.264, HEVC, MJPEG, MPEG-1/2/4, VP8/VP9, VC-1, AV1. Codec support varies by hardware (see the [​](https://developer.nvidia.com/video-encode-decode-gpu-support-matrix)).
...
- [​](https://multimedia.cx/eggs/mac-hwaccel-video/)
- [​](https://lists.ffmpeg.org/pipermail/libav-user/2013-September/005463.html)
- [​](https://stackoverflow.com/questions/23289157/how-to-use-hardware-acceleration-with-ffmpeg)

[Version 99 by Mads Johansen: Added how to show what hwaccels are available because I got tired of not having that information](https://trac.ffmpeg.org/wiki/HWAccelIntro?action=diff&version=99) [See timeline at Oct 28, 2024, 6:39:23 PM](https://trac.ffmpeg.org/timeline?from=2024-10-28T18%3A39%3A23Z&precision=second)
...
- [Plain Text](https://trac.ffmpeg.org/wiki/HWAccelIntro?format=txt)